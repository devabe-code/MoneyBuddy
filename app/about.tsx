...
export default function AboutScreen() {
  return (
    <Screen
      title="A plan you can explain"
      subtitle="MoneyBuddy connects everyday cashflow to the goals that matter."
    >
      {MONEYBUDDY_EXPLAINER_STEPS.map((step, index) => (
        <ExplainerStep {...step} key={step.title} number={index + 1} />
      ))}
      <TextLink
