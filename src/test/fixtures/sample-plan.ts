  ...
  journey: [
    {
      ...
      description: 'A first buffer for the unexpected.',
    ...
    },
    {
      date: 'March 2027',
      name: 'Emergency fund',
      description: 'Three months of synthetic planned expenses.',
      status: '62% complete',
      complete: false,
    ...
    },
    {
      date: 'January 2028',
      name: 'Next car',
      description: 'A cash goal that follows the emergency fund.',
      status: 'Up next',
      complete: false,
