  ...
  return (
    <SurfaceCard>
      <View style={styles.heading}>
        <IconBadge
          color={compact ? tokens.color.warningInk : tokens.color.ink}
          icon={goal.icon}
          tint={goalToneTints[goal.tone ?? 'default']}
        />
        ...
        <AppText
          accessibilityLabel={`${goal.progress} percent complete`}
      ...
      {!compact && goal.date ? (
        <View style={styles.outlook}>
          ...
          <AppText style={styles.outlookText} tone="primary" variant="label">
            At this pace, target date is {goal.date}
          </AppText>
        </View>
      ) : null}
    </SurfaceCard>
